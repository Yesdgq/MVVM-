...
@interface SecondHomePageViewViewModel ()

@property (nonatomic, strong) NSMutableArray <SecondHomePageViewModel *>*arrayData;
...
- (void)requestData:(void (^)(void))block{
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        self.arrayData = [SecondHomePageViewModel loadData:data];
